...
class BaseClient:
    ...
    def _kwargs_send_notification(
        self, notification_body: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _kwargs_view_notifications(
    ...
    def _kwargs_notification_history(
    ...
    def _kwargs_delete_segments(self, segment_id: str) -> Dict[str, Any]:
        return {
            "method": "DELETE",
            "url": self._get_path(
                SEGMENT_PATH, app_id=self.app_id, segment_id=segment_id
            ),
            "token": self.rest_api_key,
        }

    def _kwargs_view_outcomes(
...
class AsyncClient(BaseClient):
    ...
    async def delete_segment(self, segment_id: str) -> OneSignalResponse:
        ...
        """
        return await async_basic_auth_request(
            **self._kwargs_delete_segments(segment_id)
        )
    ...
    async def update_app(
        self, app_id: str, app_body: Dict[str, Any]
    ) -> OneSignalResponse:
        """
