...
class TestClient:
    ...
    async def test_send_notification(
        self, client: AsyncClient, ok_response: MockHttpxResponse
    ):
    ...
    @pytest.mark.asyncio
    async def test_view_notification(
        self, client: AsyncClient, ok_response: MockHttpxResponse
    ):
        notification_id = "notification-one-id"
        with mock.patch(
    ...
    @pytest.mark.asyncio
    async def test_view_notifications(
        self, client: AsyncClient, ok_response: MockHttpxResponse
    ):
